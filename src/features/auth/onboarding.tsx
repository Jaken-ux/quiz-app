      ...
      <div className="flex h-full flex-col overflow-y-auto">
        <div className="relative overflow-hidden rounded-b-[2.5rem] bg-gradient-to-br from-[#E63946] via-[#EE5A6A] to-[#FFB703] px-6 pt-[calc(env(safe-area-inset-top)+2.5rem)] pb-12">
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-1.5 rounded-full bg-white/25 px-3 py-1 text-[11px] font-black uppercase tracking-widest text-white backdrop-blur">
              🎉 Välkommen
            </div>
